...
export default async function main() {
    ...
    const req = await fetch("../../GS/train.splat");
    console.log("这是那个模型吗-----data:",req);
    ...
    let uint32Array = new Uint32Array(req.headers.get("content-length"));
    let buffer = uint32Array.buffer;
    let splatData = new Uint8Array(buffer);

    // splatData = JSON.parse(splatData);
    console.log("这是splatData-----",splatData);
    const downsample =
